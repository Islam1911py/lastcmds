...
"[project]/Desktop/cmd-main/src/app/api/invoices/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const normalizeInvoice = (invoice)=>{
    ...
    const { operationalExpenses: _op, expenses: _unitExpenses, payments: _payments, ...rest } = invoice;
    return {
        ...rest,
...
async function GET(req, { params }) {
    try {
        ...
        const invoice = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].invoice.findUnique({
            where: {
                id
            },
            include: {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(normalizeInvoice(invoice));
    } catch (error) {
...
async function PATCH(req, { params }) {
    try {
        ...
        const existingInvoice = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].invoice.findUnique({
            where: {
                id
            }
        });
        ...
        if (action === "mark-paid" || action === "pay") {
            ...
            const paymentAmount = action === "mark-paid" ? existingInvoice.remainingBalance : amount;
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].$transaction(async (tx)=>{
            ...
            const refreshed = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].invoice.findUnique({
                where: {
                    id
                },
                include: {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(normalizeInvoice(refreshed));
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__46e3ae0e._.js.map