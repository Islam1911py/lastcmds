...
"[project]/Desktop/cmd-main/src/app/api/payroll/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$node_modules$2f$next$2d$auth$2f$next$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/cmd-main/node_modules/next-auth/next/index.js [app-route] (ecmascript)");
...
async function GET(req) {
    try {
        const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$node_modules$2f$next$2d$auth$2f$next$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getServerSession"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authOptions"]);
        ...
        const payrolls = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].payroll.findMany({
            include: {
                payrollItems: true,
                createdByUser: {
                    select: {
        ...
        // @ts-ignore
        const allAdvances = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].staffAdvance.findMany({
            where: {
                status: "PENDING"
            }
        });
        ...
        const formattedPayrolls = payrolls.map((payroll)=>{
            ...
            const updatedItems = payroll.payrollItems.map((item)=>{
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(formattedPayrolls);
    } catch (error) {
...
async function POST(req) {
    try {
        ...
        // @ts-ignore - النموذج موجود في Prisma
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].payroll.findFirst({
            where: {
                month
            }
        });
        ...
        const staffMembers = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].staff.findMany({
            include: {
        ...
        const payrollItems = staffMembers.map((staff)=>{
            const salary = staff.salary || 0;
            // @ts-ignore
            const advances = staff.advances.reduce((sum, adv)=>sum + adv.amount, 0);
        ...
        // @ts-ignore - النموذج موجود في Prisma
        const payroll = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].payroll.create({
            data: {
                month,
                totalGross,
                totalAdvances,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(payroll, {
            status: 201
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__881c94c8._.js.map