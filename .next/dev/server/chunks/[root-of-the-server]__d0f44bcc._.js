...
"[project]/Desktop/cmd-main/src/app/api/summary/unit/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        // Get residents count
        const residentsCount = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].resident.count({
            where: {
                unitId
            }
        });
        ...
        const [totalTickets, newTickets, inProgressTickets, doneTickets] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].ticket.count({
                where: {
                    unitId
                }
            }),
        ...
        const [totalDeliveries, newDeliveries, inProgressDeliveries, deliveredDeliveries] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].deliveryOrder.count({
                where: {
                    unitId
                }
            }),
        ...
        const activeTicketsCount = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].ticket.count({
            where: {
                unitId,
                status: {
                    in: [
        ...
        const pendingDeliveriesCount = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].deliveryOrder.count({
            where: {
                unitId,
                status: {
                    in: [
        ...
        const [totalTechWork, techWorkStats] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].technicianWork.count({
                where: {
                    unitId
                }
            }),
            __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].technicianWork.aggregate({
                where: {
                    unitId
                },
                _sum: {
        ...
        const [totalExpenseNotes, pendingExpenseNotes, expenseNotesStats] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].unitExpense.count({
                where: {
                    unitId
                }
            }),
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].unitExpense.aggregate({
                where: {
                    unitId
                },
                _sum: {
        ...
        const [totalInvoices, paidInvoices, unpaidInvoices] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].invoice.count({
                where: {
                    unitId
                }
            }),
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(summary);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d0f44bcc._.js.map