...
"[project]/Desktop/cmd-main/src/app/api/technicians/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, context) {
    ...
    try {
        ...
        const technician = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].technician.findUnique({
            where: {
                id
            },
            include: {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(technician);
    } catch (error) {
...
async function PUT(req, context) {
    ...
    try {
        ...
        const technician = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].technician.update({
            where: {
                id
            },
            data: updateData
...
async function DELETE(req, context) {
    ...
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].technicianWork.deleteMany({
            where: {
                technicianId: id
            }
        });
        // Delete related payments
        await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].technicianPayment.deleteMany({
            where: {
                technicianId: id
            }
        });
        // Now delete the technician
        await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].technician.delete({
            where: {
                id
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c23141c7._.js.map