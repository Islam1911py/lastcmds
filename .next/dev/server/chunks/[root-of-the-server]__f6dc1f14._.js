...
"[project]/Desktop/cmd-main/src/app/api/technicians/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const technicians = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].technician.findMany({
            include: {
                works: {
                    include: {
                        unit: {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(technicians);
    } catch (error) {
...
async function POST(req) {
    try {
        ...
        const technician = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].technician.create({
            data: {
                name,
                phone: phone || null,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f6dc1f14._.js.map