...
"[project]/Desktop/cmd-main/src/app/api/staff/advances/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const normalizedStatus = statusParam && [
            "PENDING",
            "DEDUCTED"
        ].includes(statusParam) ? statusParam : undefined;
        // @ts-ignore - النموذج موجود في Prisma
        const advances = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].staffAdvance.findMany({
            where: {
                ...staffId ? {
                    staffId
                } : {},
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(advances);
    } catch (error) {
...
async function POST(req) {
    try {
        ...
        // Verify staff exists
        const staff = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].staff.findUnique({
            where: {
                id: staffId
            }
        });
        ...
        // @ts-ignore - النموذج موجود في Prisma
        const advance = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].staffAdvance.create({
            data: {
                staffId,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(advance, {
            status: 201
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ec0493fa._.js.map