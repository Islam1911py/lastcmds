...
"[project]/Desktop/cmd-main/src/app/api/invoices/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const prisma = __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"];
async function GET(req) {
    try {
        ...
        const normalized = invoices.map((invoice)=>{
            ...
            const { operationalExpenses: _op, expenses: _unitExpenses, payments: _payments, ownerAssociation: rawOwnerAssociation, ...rest } = invoice;
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$cmd$2d$main$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(normalized);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b504d62b._.js.map